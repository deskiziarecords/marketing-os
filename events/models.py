...
class DomainEvent(models.Model):
    ...
    class Meta:
        ordering = ['created_at']# events/models.py
import uuid
from django.db import models
from django.utils import timezone
...
class DomainEvent(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    event_type = models.CharField(max_length=100, db_index=True) # ej: 'lead.created', 'ai.generation.completed'
    ...
    class Meta:
        ordering = ['created_at']
        indexes = [
            models.Index(fields=['status', 'created_at']), # Optimiza la consulta del worker
        ]
